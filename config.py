...
MONGO_DB_URI = getenv("mongodb+srv://ms7371091:ms7371091@cluster0.vwfw6.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0", None)

DURATION_LIMIT_MIN = int(getenv("DURATION_LIMIT", 60))

# Chat id of a group for logging bot's activities
LOG_GROUP_ID = int(getenv("-1002467044807", None))

# Get this value from @MissRose_Bot on Telegram by /id
OWNER_ID = int(getenv("6943348077", None))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/+565zq0XLr2g1ZjI1")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/+zdzQ87N-ntxiZDNl")
